...
class PictureController {
    ...
    /**
     * @api {post} https://api.mobile.local.19343/users/:id/pictures/ Créer
     * @apiGroup Pictures
     *
    ...
    /**
     * @api {post} https://api.mobile.local.19343/users/:id_user/series/:id_series/pictures/ Ajouter à une Series
     * @apiGroup Pictures
     *
